...
import com.ttit.device.api.enums.DevLogTypeEnum;
import com.ttit.device.api.enums.DeviceStatusEnum;
import com.ttit.device.api.enums.DictTypeEnum;
import com.ttit.device.api.enums.ReportTypeEnum;
...
public class DeviceInfoServiceImpl implements DeviceInfoService {
    ...
    public DeviceInfoVo regist(DeviceInfo deviceInfo, String userId) {
        ...
        deviceInfo.setGroupId(Constant.GROUP_DEFAULT_ID);

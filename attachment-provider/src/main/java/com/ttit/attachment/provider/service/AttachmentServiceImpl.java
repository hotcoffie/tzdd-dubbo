package com.ttit.attachment.provider.service;
...
import com.ttit.attachment.provider.dao.AttachmentDao;
...
@Service(interfaceClass = AttachmentDubboService.class, version = "1.0.0")
@Component
@Slf4j

...
import com.ttit.device.api.service.DeviceInfoService;
...
public class DeviceInfoController {
    ...
    @Reference(interfaceClass = DeviceInfoService.class)
    private DeviceInfoService attachmentDubboService;
    ...
    public ResultVo searchPage(@ApiParam(value = "分组ID") @RequestParam(required = false) String groupId,
        ...
        PageInfo page = attachmentDubboService.searchPage(groupId, keyword, pageNum, pageSize, orderBy);
    ...
    public ResultVo regist(@RequestBody DeviceInfo deviceInfo) {
        DeviceInfoVo info = attachmentDubboService.regist(deviceInfo, Constant.USER_ID_ADMIN);
    ...
    public ResultVo del(@ApiParam(value = "设备ID", required = true) @PathVariable String id) {
        //用户体系暂未规划，这里默认用1
        DeviceInfoVo deviceInfoVo = attachmentDubboService.del(id, Constant.USER_ID_ADMIN);
    ...
    public ResultVo modify(@ApiParam(value = "设备信息") @RequestBody DeviceInfo deviceInfo) {
        DeviceInfoVo info = attachmentDubboService.modify(deviceInfo, Constant.USER_ID_ADMIN);
        return ResultVo.success(info);
    }
    ...
    public ResultVo modifyGroup(@ApiParam(value = "设备ID", required = true) @RequestParam String id,
        ...
        DeviceInfoVo info = attachmentDubboService.modifyGroup(id, groupId, Constant.USER_ID_ADMIN);
        return ResultVo.success(info);
    }
    ...
    public ResultVo report(@ApiParam(value = "设备ID", required = true) @RequestParam String id,
        ...
        attachmentDubboService.report(reportVo);
    ...
    public ResultVo legalize(@ApiParam(value = "设备ID", required = true) @RequestParam String id,
        ...
        attachmentDubboService.legalize(id, serialNum, serialCode);
        return ResultVo.success("OK");
    }
}
